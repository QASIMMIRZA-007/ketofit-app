      ...
      <section id='ketotaste'>
        <div className='keto-container'>
          <div className='keto-header'>
            <h1>A day with <span className="greenColor">KetoFit</span></h1>
            <p>Lose weight by eating the foods you love.</p>
            <div className='rectangle'>
              <button
              className={selectedCategory === 'breakfast' ? 'active' : ''}
               onClick={() => handleCategoryClick('breakfast')}>Breakfast</button>
              <button
              className={selectedCategory === 'lunch' ? 'active' : ''}
               onClick={() => handleCategoryClick('lunch')}>Lunch</button>

              <button
              className={selectedCategory === 'dinner' ? 'active' : ''}
              onClick={() => handleCategoryClick('dinner')}>Dinner</button>

              <button
              className={selectedCategory === 'snacks' ? 'active' : ''}
              onClick={() => handleCategoryClick('snacks')}>Snacks</button>
            </div>
          </div>
          <div className='cards'>
            {
